...
namespace Landlord2.Data
{
    ...
    public partial class 源房缴费明细
    {
        ...
        /// 预编译查询0 -- 查询所有源房缴费明细
        /// </summary>
        public static IEnumerable<源房缴费明细> GetPayDetails()
        {
        ...
        /// 预编译查询1 -- 根据源房ID和缴费项2个条件过滤
        /// </summary>
        public static IEnumerable<源房缴费明细> GetPayDetails(Guid guid, string 缴费项)
        {
        ...
        /// 预编译查询2 -- 根据源房ID过滤
        /// </summary>
        public static IEnumerable<源房缴费明细> GetPayDetails(Guid guid)
        {
        ...
        /// 预编译查询3 -- 根据缴费项过滤
        /// </summary>
        public static IEnumerable<源房缴费明细> GetPayDetails(string 缴费项)
        {
