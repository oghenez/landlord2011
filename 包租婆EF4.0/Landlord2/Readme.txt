...
5.1、退租时的结算操作：
   ...
   ****提前退租，和逾期退租，计算时需要考虑提前或逾期时间的相应费用。***
   ...
   3.结清后（此退租行为可视为一种特殊的收租操作），客房租金明细表需插入记录、出租历史记录表需插入记录并指定状态为‘正常退租、提前退租、逾期退租’之一。
...
5.2、退租操作同样会新增一条【客房租金明细】记录，起付日期和止付日期根据不同情况而定：
   ...
   2、提前退租情况下租户已缴纳本期租金物业等，退租操作不仅需要计算水电气和押金，同时需要计算退还给租户的租金物业等费用。此时新增的客房租金明细的起付日期=止付日期=结算日期；
   3、其他情况下(包括正常退租提前退租但未付本期租金)，起付日期与上次租金明细的止付日期连续，止付日期=结算日期。
